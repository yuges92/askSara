      ...
      <div class="container" id="mainContent">
        ...
        <div class="card-section">
          <div class="container">
                          ...
                          <div class=" text-dark rounded row">
                            <div class="m-auto ">
                              <div class="">
                                ...
                                <img class="rounded" src="{{$disclaimer->image}}" alt="{{$disclaimer->title}}"> @endif
            ...
            </div>{{-- Report Section Header Discliamer End --}} {{-- Report Section Header Idea --}}
            <div class="card card-plain">
              <div class="">
                <button type="button" class="card-header card-header-secondary purple py-0 slide-collapse col-12">
                <h2 class=" row px-2"><i class="fa fa-chevron-up  ml-auto mr-1 collapse-icon"></i></h2>
              ...
              @endforeach
            </div>{{-- Report Section Header Idea End--}} {{-- Report Question--}} @if (isset($report->questions))
            <div class="card">
              {{--
              <h1>Question Body</h1> --}} @php $count=0; 
@endphp @foreach ($report->questions as $question)
              <div class="p-0 mt-5">
                  ...
                  <div class="card card-plain m-0">
                    ...
                    <div class="card-body p-0">
                      ...
                      <div class="row d-flex flex-row-reverse m-0">
                        @if ($question->disclaimers) @foreach ($question->disclaimers as $disclaimer) @if ($disclaimer)
                          ...
                          <div class=" mt-2 border border-danger">
                            <div class="card m-0 mb-3">
                              ...
                              <div class="card-body  p-2">
                                ...
                                @endif @if ($disclaimer->description)
                        ...
                        <div class="mt-0 p-0 card card-plain col-sm-12">
                          <div class="card-body p-0 ">
                            @if ( !empty($question->ideasAndProducts)) @foreach ($question->ideasAndProducts as $ideasAndProduct) @if ($ideasAndProduct->idea)
                            <div class=" row  m-0 ">
                              <div class="col-sm-12">
                                <h3 class="title"> {{ $ideasAndProduct->idea->title }} </h3>
                              </div>
                              @if ($ideasAndProduct->idea->image)
                              <div class="mx-auto p-0 pb-2 m-0">
                                <img src="{{ $ideasAndProduct->idea->image }}" alt="">
                              </div>
                              @endif
                              <div class="{{ $ideasAndProduct->idea->image ? 'col-lg-10':'' }} p-1">
                                <div class="text-left px-md-3 p-1">
                                  {!! $ideasAndProduct->idea->description !!}
                                </div>
                              </div>
                            </div>
                            @if ($ideasAndProduct->idea->references)
                            <div class=' p-3 text-right btn-link'>
                              <a rel='popup' href="">View References and sources of further information</a>
                            </div>
                            @endif @endif @if (!empty($ideasAndProduct->products))
                            <div class="px-4 rel-prod">
                              <div class="">
                                ...
                                <div class="row p-0 d-flex justify-content-center justify-content-md-start">
                                  @foreach ($ideasAndProduct->products as $product) @if ($product)
                                  <div class="card mx-2 mt-1 mb-2" style="width: 12rem; height:16rem;">
                                    ...
                                    <div class="card-footer justify-content-center">
                                      <a href="{{$product->link }}" class="btn btn-primary btn-round" title="View product" target="_blank">View</a>
                                    </div>
                            ...
                            @endif @if (!empty($ideasAndProduct->groupProducts))
                            <div class="px-4 rel-prod">
                              <div class="">
                                <div class="">
                                ...
                                <div class="row p-0 d-flex justify-content-center justify-content-md-start">
                                  @foreach ($ideasAndProduct->groupProducts as $product) 
                                  @if ($product)
                                  <div class="card mx-2 mt-1 mb-2" style="width: 12rem; height:16rem;">
                                    <img class="card-img-top " style="max-height:8rem;" src="{{ $product->image }}" alt="">
                                    <div class="card-body text-left mx-auto px-2 py-0">
