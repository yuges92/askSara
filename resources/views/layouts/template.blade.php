    ...
    <nav class="navbar navbar-color-on-scroll   navbar-expand-lg"  id="sectionsNav" >
      <div class="container-fluid">
        ...
        <div class="pull-right" >
          ...
          <a class="report-link" data-toggle="modal" href="#myModal" >  <span class="fa-stack fa-2x has-badge" data-count=" {{$topics ? count($topics) : ''}}">
            ...
            <div class="modal-body">
                <ul>
                  ...
                  @foreach ($topics as $topic)
                    ...
                    <li> <a href="/reports/{{$topic->subTopic_id}}">
                      {{$topic->name}}                        </a>
                    </li>
                  @endforeach
                </ul>
